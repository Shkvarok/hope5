...
<head>
    <link rel="stylesheet" href="css/style_logre.css">
</head>
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="login-form">
                    ...
                    <form action="login.php" method="post">
                        ...
                        <button name="login" class="site-btn login-btn">Увійти</button>
                    </form>
                    <div class="switch-login">
                        <a href="register.php" class="or-login">або створити акаунт</a>
                    </div>
                </div>
            </div>
        </div>
